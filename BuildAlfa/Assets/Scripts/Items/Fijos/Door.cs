...
public class Door : ItemsCloosers
{
    ...
    public override void Interact()
    {
       ...
       if (ID.ID == 10 && inventory.FindItemInInventory(1) != null)
        {
            if (!opened)
            {
                anim.SetBool("open", true);
        ...
        if (ID.ID == 20 && inventory.FindItemInInventory(7) != null)
        {
            if (!opened)
            {
                anim.SetBool("open", true);
    ...
    private void Update()
    {
        if (PlayerContact)
        {
            ...
            {
                if(inventory.FindItemInInventory(7) != null)
                {
                    if (opened)
                    {
                        TextToUse.text = "Pulsa[F] para Cerrar.";
                ...
                {
                    TextToUse.text = "Necesito una tarjeta de seguridad";
                }

            }
            else if (ID.ID == 10)
            {
                if (inventory.FindItemInInventory(1) != null)
                {
                    if (opened)
                    {
                        TextToUse.text = "Pulsa[F] para Cerrar.";
                ...
                {
                    TextToUse.text = "Necesito una llave";
                }
